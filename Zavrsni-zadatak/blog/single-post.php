...
<div class="blog-post">
  ...
  <form action="delete-post.php" method="post" name="deletePost">
    <button id="deleteBtn" type="submit" onclick="return areYouSure()">Delete Post</button>
    <input name="postId" type="hidden" value="<?php echo $postsId?>">
...
<script> // JavaScript za dodavanje komentara
   function addComment (){
   ...
   <button class="btn btn-default" id='hideBtn'>Hide comments</button>
           ...
           <div class="singleComment">
               ...
               <?php foreach($singlePostsComms as $singlePostsComm) {?>
                   <li>
                    ...
                    <form action="delete-comment.php" method="post" name="deleteForm">
           ...
           <script>
               ...
               var singleComment = document.querySelector('.singleComment');

               myBtn.addEventListener('click', function() {
                   if(myBtn.innerText == 'Hide comments') {
                       myBtn.innerText = 'Show comments';
                       singleComment.classList.add('hidden');
                   } else {
                       myBtn.innerText = 'Hide comments';
                       singleComment.classList.remove('hidden');
                   }
               });
           </script>
